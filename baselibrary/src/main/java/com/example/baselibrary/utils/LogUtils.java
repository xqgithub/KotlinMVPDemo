    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = MyApplication.myapplication.getApplicationContext().getExternalCacheDir() + File.separator + "log" + File.separator;

            } else {
                dir = MyApplication.myapplication.getApplicationContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
